...
#        print('in generate_lotto_numbers')
        lotto_numbers = new_random_list(lotto_numbers,1,60)
...
def generate_euro_numbers():
    ...
    star_numbers = []
    for i in range(5):
        euro_numbers = new_random_list(euro_numbers,1,51)
    for i in range(2):
        star_numbers = new_random_list(star_numbers,1,13)
...
def new_random_list(number_list_arg,min,max):
