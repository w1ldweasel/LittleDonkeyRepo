...
mycursor.execute("CREATE TABLE threatlibrary (Characteristics VARCHAR(50), CharacteristicGuidance VARCHAR(255), Threat VARCHAR(255), ThreatDescription VARCHAR(255), Requirement VARCHAR(255), AssuranceRequirement VARCHAR(255))")#this allows us to make the table called threatlibrary with 6 variables these will act as columns
